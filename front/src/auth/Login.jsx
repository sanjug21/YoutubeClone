    ...
    <div className='min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500'>
        <div className='bg-slate-200 p-8 rounded-lg shadow-2xl w-96 ' >
            <div className='flex flex-col justify-center items-center space-y-3 p-2 '>
                ...
                <button className='bg-red-600 text-white rounded-2xl p-1  h-10 sm:w-1/2' onClick={Login}>login</button>
            </div>
            <Link className='flex justify-center item-center text-blue-400' to={'/signup'}>Don't have an account</Link>
        </div>
